...
<section class="content">
      ...
      <div class="row">
		...
		<tr>
			...
			<td><a href="/patientdischargeadd">Add</a>|<a href="patientdischargeedit/{{$d->patientdischarge_id}}">Edit</a>|<a href="patientdischargedel/{{$d->patientdischarge_id}}">Delete</a></td>
