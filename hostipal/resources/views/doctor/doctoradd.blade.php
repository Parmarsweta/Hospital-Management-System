      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="drdoctoradd" method="post">
            @csrf
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="doctorname" name="doctorname" required placeholder="Enter Your Name">
                </div>

                <div class="form-group">
                  <label for="exampleInputqualification">qualification :</label>
                  <input type="text" class="form-control" id="qualification" name="txt" required placeholder="Enter Your Qualification ">
                </div>

                <div class="form-group">
                  <label for="exampleInputAddress">address :</label>
                  <input type="address" class="form-control" id="address" name="address" required placeholder="Enter your Address">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="doctorvisiting" name="doctorvisiting" required placeholder="Enter Your visiting">
                </div>

                <div class="form-group">
                  <label for="exampleInputAdmin_name">doctorcharge :</label>
                  <input type="text" class="form-control" id="doctorcharge" name="doctorcharge" required placeholder="Enter Your Doctorcharge">
                </div>
