      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/doctoredit/{{$data->doctor_id}}" method="post">
            @csrf
    
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputdoctor">doctor_id :</label>
                  <input type="number" class="form-control" id="doctorid" name="doctorid" value='{{$data->doctor_id}}' >
                </div>
                <div class="form-group">
